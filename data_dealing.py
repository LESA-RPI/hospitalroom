...
if __name__ == '__main__':
    ...
    # activity 4
    add_data(merge_data(np.loadtxt("mo_4_0.txt"), np.loadtxt("mo_4_1.txt")), 4, all_data, label)
    add_data(merge_data(np.loadtxt("daniel_4_0.txt"), np.loadtxt("daniel_4_1.txt")), 4, all_data, label)
    add_data(merge_data(np.loadtxt("isaac_4_0.txt"), np.loadtxt("isaac_4_1.txt")), 4, all_data, label)
    add_data(merge_data(np.loadtxt("ruijie_4_0.txt"), np.loadtxt("ruijie_4_1.txt")), 4, all_data, label)
    add_data(merge_data(np.loadtxt("hh_4_0.txt"), np.loadtxt("hh_4_1.txt")), 4, all_data, label)
    # activity 5
    add_data(merge_data(np.loadtxt("mo_5_0.txt"), np.loadtxt("mo_5_1.txt")), 5, all_data, label)
    add_data(merge_data(np.loadtxt("daniel_5_0.txt"), np.loadtxt("daniel_5_1.txt")), 5, all_data, label)
    add_data(merge_data(np.loadtxt("isaac_5_0.txt"), np.loadtxt("isaac_5_1.txt")), 5, all_data, label)
    add_data(merge_data(np.loadtxt("ruijie_5_0.txt"), np.loadtxt("ruijie_5_1.txt")), 5, all_data, label)
    add_data(merge_data(np.loadtxt("hh_5_0.txt"), np.loadtxt("hh_5_1.txt")), 5, all_data, label)
    # activity 6
    add_data(merge_data(np.loadtxt("mo_6_0.txt"), np.loadtxt("mo_6_1.txt")), 6, all_data, label)
    add_data(merge_data(np.loadtxt("daniel_6_0.txt"), np.loadtxt("daniel_6_1.txt")), 6, all_data, label)
    add_data(merge_data(np.loadtxt("isaac_6_0.txt"), np.loadtxt("isaac_6_1.txt")), 6, all_data, label)
    add_data(merge_data(np.loadtxt("ruijie_6_0.txt"), np.loadtxt("ruijie_6_1.txt")), 6, all_data, label)
    add_data(merge_data(np.loadtxt("hh_6_0.txt"), np.loadtxt("hh_6_1.txt")), 6, all_data, label)
